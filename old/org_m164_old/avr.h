...
#define cli() asm volatile ("cli")	// disenable interrupt
#define sei() asm volatile ("sei")	// enable interrupt
#define ret() asm volatile ("ret")	// set ret 
#define reti() asm volatile ("reti")	// set reti
